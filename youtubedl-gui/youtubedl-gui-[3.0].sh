...
STR_APPNAME="youtubedl-gui"
STR_MAINTAINER="nsthy@hotmail.com"
STR_DESCRIPTION_SHORT="GUI on yt-dlp (ie, youtube-dl) to download videos"
STR_DESCRIPTION="GUI on yt-dlp (ie, youtube-dl) to download videos from a variety of sites
...
if [ "$(uname)" = "FreeBSD" ]; then
    	...
    	#vvvvvvvvvv EDIT vvvvvvvvvv
	STR_DEPEND_DEB="gcc12, qt5, yt-dlp"
	#^^^^^^^^^^ EDIT ^^^^^^^^^^
	...
	STR_PREFIX="usr"
	#vvvvvvvvvv EDIT vvvvvvvvvv
	STR_DEPEND_DEB="libc6, libgcc-s1, libqt5core5a, libqt5gui5, libqt5widgets5, libstdc++6, yt-dlp"
	STR_DEPEND_RPM="yt-dlp qt5-qtbase"
	STR_DEPEND_ARCHPKG="yt-dlp qt5-base"
	#^^^^^^^^^^ EDIT ^^^^^^^^^^
...
#vvvvvvvvvv EDIT vvvvvvvvvv
URL_HOMEPAGE="https://github.com/JaGoLi/ytdl-gui"
URL_DOWNLOAD="https://github.com/JaGoLi/ytdl-gui/archive/refs/tags/${STR_VERSION}.tar.gz"

STR_ENV_DEPEND_FREEBSD="cmake qt5 gcc"
STR_ENV_DEPEND_DEBIAN="cmake qtbase5-dev build-essential"
STR_ENV_DEPEND_GENTOO="dev-util/cmake dev-qt/qtbase"
STR_ENV_DEPEND_FEDORA="cmake qt5-qtbase-devel"
STR_ENV_DEPEND_ARCHLINUX="cmake qt5-base base-devel"
...
src_configure() {
	...
	# vvvvvvvvvv [DIY CODE] vvvvvvvvvv
	cd ${DIR_HOME_WORKING}
	api_mkdir build && cd build
	api_verbose_run "cmake .."
...
src_pack() {
	...
	# vvvvvvvvvv [DIY CODE] vvvvvvvvvv
	api_deb_install_bin ${DIR_HOME_WORKING}/build/youtubedl-gui
	api_replace "/usr/bin/" "/${STR_PREFIX}/bin/" "${DIR_HOME_WORKING}/resources/youtubedl-gui.desktop"
	api_deb_install_desktop ${DIR_HOME_WORKING}/resources/youtubedl-gui.desktop
	mv ${DIR_HOME_WORKING}/icons/ytdl_logo.svg ${DIR_HOME_WORKING}/icons/youtubedl-gui.svg
	api_deb_install_icon ${DIR_HOME_WORKING}/icons/youtubedl-gui.svg
