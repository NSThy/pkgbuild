...
STR_LICENSE="MIT"
STR_MD5="examplemd5string"
STR_FILENAME="example.tar.gz"
STR_APPNAME="example-app"
STR_MAINTAINER="nsthy@hotmail.com"
STR_DESCRIPTION_SHORT="exampleexample"
STR_DESCRIPTION="exampleexampleexampleexampleexampleexampleexample"
#^^^^^^^^^^ EDIT ^^^^^^^^^^
STR_ARCH2=$(uname -m)
...
if [ "$(uname)" = "FreeBSD" ]; then
    	...
    	#vvvvvvvvvv EDIT vvvvvvvvvv
	STR_DEPEND_DEB="example, example, example"
	#^^^^^^^^^^ EDIT ^^^^^^^^^^
	...
	#vvvvvvvvvv EDIT vvvvvvvvvv
	STR_DEPEND_DEB="example, example, example"
	STR_DEPEND_RPM="example example"
	STR_DEPEND_ARCHPKG="example example"
	#^^^^^^^^^^ EDIT ^^^^^^^^^^
...
#vvvvvvvvvv EDIT vvvvvvvvvv
URL_HOMEPAGE="https://example.com/example/example"
URL_DOWNLOAD="https://example.com/example/example/archive/refs/tags/${STR_VERSION}.tar.gz"

STR_ENV_DEPEND_FREEBSD="example qt5 gcc"
STR_ENV_DEPEND_DEBIAN="example qtbase5-dev build-essential"
STR_ENV_DEPEND_GENTOO="example/example dev-qt/qtbase"
STR_ENV_DEPEND_FEDORA="example qt5-qtbase-devel"
STR_ENV_DEPEND_ARCHLINUX="example qt5-base base-devel"
