...
STR_LICENSE="MIT"
STR_MD5="7a7f252efd4a75bbcdb4747218c85486"
STR_FILENAME="v23.12.07-HeavySnow.b0086d5c.tar.gz"
STR_APPNAME="goldendict-ng"
STR_MAINTAINER="nsthy@hotmail.com"
STR_DESCRIPTION_SHORT="The Next Generation GoldenDict."
STR_DESCRIPTION="The Next Generation GoldenDict. A feature-rich open-source dictionary lookup program, supporting multiple dictionary formats and online dictionaries."
#^^^^^^^^^^ EDIT ^^^^^^^^^^
STR_ARCH2=$(uname -m)
...
if [ "$(uname)" = "FreeBSD" ]; then
    	...
    	#vvvvvvvvvv EDIT vvvvvvvvvv
	STR_DEPEND_DEB="ffmpeg, qt6, ja-eb, libzim, xapian-core, R-cran-hunspell, lzo2, zh-opencc, libvorbis, bzip2, lzlib, libXtst"
	#^^^^^^^^^^ EDIT ^^^^^^^^^^
	...
	STR_PREFIX="usr"
	#vvvvvvvvvv EDIT vvvvvvvvvv
	STR_DEPEND_DEB="qml6-module-qtquick3d-spatialaudio, libxtst6, libavformat59, eb-utils, libzim8, libxapian30, hunspell, liblzo2-2, opencc, libvorbis0a, bzip2, zlib1g, libqt6multimedia6, libqt6texttospeech6, libqt6svg6, libqt6webenginecore6, libavutil57, libqt6core5compat6"
	STR_DEPEND_RPM="libavutil-free libXtst libavformat-free qt6-qtbase ffmpeg-free eb libzim xapian-core hunspell lzo opencc libvorbis bzip2 zlib qt6-qt5compat qt6-qtwebengine qt6-qttools qt6-qtsvg qt6-qtspeech qt6-qtmultimedia"
	STR_DEPEND_ARCHPKG="ffmpeg hunspell libeb libvorbis libzim lzo opencc qt6-base zlib qt6-multimedia qt6-speech qt6-svg qt6-webengine xapian-core xz zlib qt6-tools"
	#^^^^^^^^^^ EDIT ^^^^^^^^^^
...
#vvvvvvvvvv EDIT vvvvvvvvvv
URL_HOMEPAGE="https://github.com/xiaoyifang/goldendict-ng"
URL_DOWNLOAD="https://github.com/xiaoyifang/goldendict-ng/archive/refs/tags/v$STR_VERSION-HeavySnow.b0086d5c.tar.gz"

STR_ENV_DEPEND_FREEBSD="ffmpeg qt6 ja-eb libzim xapian-core R-cran-hunspell lzo2 zh-opencc libvorbis bzip2 lzlib libXtst"

STR_ENV_DEPEND_DEBIAN="qml6-module-qtquick3d-spatialaudio libxtst-dev qt6-tools-dev libavformat-dev qt6-base-dev libeb16-dev libzim-dev libavutil-dev libxapian-dev libhunspell-dev liblzo2-dev libopencc-dev libvorbis-dev zlib1g-dev qt6-multimedia-dev qt6-speech-dev qt6-svg-dev qt6-webengine-dev qt6-5compat-dev libbz2-dev"

STR_ENV_DEPEND_GENTOO="dev-qt/qtspeech dev-qt/qt5compat dev-qt/qtmultimedia dev-qt/qtwebengine app-arch/xz-utils dev-libs/lzo sys-libs/zlib app-arch/bzip2 media-libs/libvorbis app-i18n/opencc app-text/hunspell dev-libs/xapian dev-libs/eb app-arch/libzim"

STR_ENV_DEPEND_FEDORA="libavutil-free-devel libXtst-devel libavformat-free-devel ffmpeg-free-devel qt6-qtbase-devel qt6-qttools-devel eb-devel libzim-devel xapian-core-devel hunspell-devel lzo-devel opencc-devel libvorbis-devel bzip2-devel zlib-devel qt6-qtmultimedia-devel qt6-qtspeech-devel qt6-qtsvg-devel qt6-qtwebengine-devel qt6-qt5compat-devel"

STR_ENV_DEPEND_ARCHLINUX="ffmpeg fmt hunspell libeb libvorbis libxtst libzim lzo opencc qt6-5compat qt6-base qt6-multimedia qt6-speech qt6-svg qt6-webengine tomlplusplus xapian-core xz zlib cmake git ninja qt6-tools"
...
src_configure() {
	...
	if [ "$STR_OSID" = "freebsd" ]; then
		...
		api_verbose_run "qmake6 \"CONFIG+=release\" .."
	else
		cd $DIR_HOME_WORKING
		mkdir build
		api_verbose_run "cmake -S . -B build \
	      	--install-prefix=/usr/ \
...
src_compile() {
	...
	# vvvvvvvvvv [DIY CODE] vvvvvvvvvv
	cd $DIR_HOME_WORKING/build
	api_verbose_run "make -j$STR_NPROC"
	...
	if [ "$STR_OSID" = "freebsd" ]; then
		...
		cd $DIR_HOME_WORKING
		api_verbose_run "cmake --build build --parallel $STR_NPROC"
	fi
...
src_pack() {
	...
	# vvvvvvvvvv [DIY CODE] vvvvvvvvvv
	api_deb_install_bin ${DIR_HOME_WORKING}/build/goldendict
	api_deb_install_desktop ${DIR_HOME_WORKING}/redist/io.github.xiaoyifang.goldendict_ng.desktop
	api_deb_install_icon ${DIR_HOME_WORKING}/redist/icons/goldendict.png
	api_deb_install_share ${DIR_HOME_WORKING}/build/locale goldendict
	api_deb_install_metainfo ${DIR_HOME_WORKING}/redist/io.github.xiaoyifang.goldendict_ng.metainfo.xml
